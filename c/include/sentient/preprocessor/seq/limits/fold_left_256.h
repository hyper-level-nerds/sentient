...
//
#
# ifndef SENTIENT_PREPROCESSOR_SEQ_FOLD_LEFT_256_H
# define SENTIENT_PREPROCESSOR_SEQ_FOLD_LEFT_256_H
#
# define SNT_PP_SEQ_FOLD_LEFT_CHECK_SNT_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, sz) 0
...
#
# define SNT_PP_SEQ_FOLD_LEFT_0(op, st, ss) SNT_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, SNT_PP_SEQ_SIZE(ss))
...
#
# define SNT_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, sz) SNT_PP_IF(SNT_PP_DEC(sz), SNT_PP_SEQ_FOLD_LEFT_I_1, SNT_PP_SEQ_FOLD_LEFT_F)(op, op(1, st, SNT_PP_SEQ_HEAD(ss)), SNT_PP_SEQ_TAIL(ss), SNT_PP_DEC(sz))
